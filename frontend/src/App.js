...
// We no longer need 'Link' for the navbar, but we'll keep it in case you want to use it elsewhere.
import {
  ...
  return (
    <div className="App-wrapper" data-bs-theme={theme}>
      <Navbar bg={theme} variant={theme} expand="lg" className="shadow-sm">
        <Container>
          {/* --- THE NAVBAR LINK FIX IS HERE --- */}
          {/* We use a simple href="/" which forces a page reload, resetting the state. */}
